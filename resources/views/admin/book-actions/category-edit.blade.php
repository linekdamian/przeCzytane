    ...
    <div class="row mt-5">
        <div class="card w-100 justify-content-center text-center shadow">
            <div class="card-header bg-warning">
                <div class="text-dark h1">Edytuj kategorię</div>
            </div>
                    ...
                    <div class="col-lg-6 mb-3">
                        <form action="{{ route('admin-category-update') }}" method="post">
                            ...
                            <div class="input-group w-100 m-3">
                                ...
                                <input name="changeName" type="text" class="text-center form-control"
                                       value="{{ $category->name }}">
                                <input type="hidden" name="name" class="text-center form-control"
                                       value="{{ $category->name }}">
                            </div>
