...
@section('adminBookToDoContent')
    ...
    <div class="row mt-5">
        <div class="col-lg-4 mb-5">
            <a class="box bg-dark text-white btn btn-lg w-100 p-4 mb-3 noshadow" href="{{ route('admin-book-add') }}">
                <div class="row justify-content-center h1 text-light mb-3 white-space-normal noshadow">
                    {{ __('Dodaj Książkę') }}
                </div>
            </a>

            <div class="box bg-warning text-dark btn btn-lg w-100 p-4 mt-3">
